...
static const std::array<std::string, static_cast<size_t>(EIngredient::INGREDIENT_COUNT)> IngredientNames = {
    "Bun",           "Patty",          "Lettuce",       "Cheese",    "Tomato",         "Onion",     "Pickles",
    "Ketchup",       "Mustard",        "Kelp",          "Seaweed",   "Barnacle Rings", "Chum",      "Jellyfish Jelly",
    "Volcano Sauce", "Tar Tar Sauce",  "Ice Cream",     "Sprinkles", "Cherry",         "Chocolate", "Vanilla",
    "Snail Treats",  "Secret Formula", "Golden Crumbs", "Salt",      "Pepper",         "Mayo",      "Relish"};
