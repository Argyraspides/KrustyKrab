...
namespace MenuItemFactory
{
    ...
    static const std::vector<Menu::EIngredient>& GetKrabbyPattyIngredients()
    {
        ...
        {
            Menu::EIngredient::Bun,
            Menu::EIngredient::Patty,
            Menu::EIngredient::Lettuce,
            Menu::EIngredient::Cheese,
            Menu::EIngredient::Tomato,
            Menu::EIngredient::Onion,
            Menu::EIngredient::Pickles,
            Menu::EIngredient::Ketchup,
            Menu::EIngredient::Mustard
        };
        return ingredients;
    }
    ...
    {
        static const Menu::MenuItem_t item
        {
    ...
    static const Menu::MenuItem_t& MakeDoubleKrabbyPatty()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::DoubleKrabbyPatty,
            GetDoubleKrabbyPattyIngredients(),
    ...
    static const std::vector<Menu::EIngredient>& GetTripleKrabbyPattySupremeIngredients()
    {
        static const std::vector<Menu::EIngredient> ingredients =
        {
            ...
            Menu::EIngredient::Ketchup,
            Menu::EIngredient::Mustard,
            Menu::EIngredient::Mayo,
            Menu::EIngredient::SecretFormula
        };
        return ingredients;
    }
    ...
    static const Menu::MenuItem_t& MakeTripleKrabbyPattySupreme()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::TripleKrabbyPattySupreme,
    ...
    static const Menu::MenuItem_t& MakeKrabbyPattyDeluxe()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::KrabbyPattyDeluxe,
            GetKrabbyPattyDeluxeIngredients(),
    ...
    static const std::vector<Menu::EIngredient>& GetBarnacleBurgerIngredients()
    {
        ...
        {
            Menu::EIngredient::Bun,
            Menu::EIngredient::BarnacleRings,
            Menu::EIngredient::Lettuce,
            Menu::EIngredient::TarTarSauce,
            Menu::EIngredient::Salt
        };
        return ingredients;
    }
    ...
    static const Menu::MenuItem_t& MakeBarnacleBurger()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::BarnacleBurger,
            GetBarnacleBurgerIngredients(),
    ...
    static const std::vector<Menu::EIngredient>& GetKelpShakeIngredients()
    {
        static const std::vector<Menu::EIngredient> ingredients =
        {
            Menu::EIngredient::Kelp,
            Menu::EIngredient::IceCream,
    ...
    static const Menu::MenuItem_t& MakeKelpShake()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::KelpShake,
            GetKelpShakeIngredients(),
    ...
    static const Menu::MenuItem_t& MakeSeaweedSalad()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::SeaweedSalad,
            GetSeaweedSaladIngredients(),
    ...
    static const Menu::MenuItem_t& MakeBarnacleRings()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::BarnacleRings,
            GetBarnacleRingsIngredients(),
    ...
    static const Menu::MenuItem_t& MakeKrustyCrab()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::KrustyCrab,
            GetKrustyCrabIngredients(),
    ...
    static const Menu::MenuItem_t& MakePlanktonsBurger()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::PlanktonsBurger,
            GetPlanktonsBurgerIngredients(),
    ...
    static const Menu::MenuItem_t& MakeChumBucket()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::ChumBucket,
            GetChumBucketIngredients(),
    ...
    static const Menu::MenuItem_t& MakeGoldenSpatula()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::GoldenSpatula,
            GetGoldenSpatulaIngredients(),
    ...
    static const Menu::MenuItem_t& MakeMonsterKrabbyPatty()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::MonsterKrabbyPatty,
            GetMonsterKrabbyPattyIngredients(),
    ...
    static const Menu::MenuItem_t& MakeKrabbyPattyPizza()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::KrabbyPattyPizza,
            GetKrabbyPattyPizzaIngredients(),
    ...
    static const Menu::MenuItem_t& MakeVolcanoSauce()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::VolcanoSauce,
            GetVolcanoSauceIngredients(),
    ...
    static const Menu::MenuItem_t& MakeJellyfishJelly()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::JellyfishJelly,
            GetJellyfishJellyIngredients(),
    ...
    static const Menu::MenuItem_t& MakeGaryTreat()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::GaryTreat,
            GetGaryTreatIngredients(),
    ...
    static const std::vector<Menu::EIngredient>& GetSundaeIngredients()
    {
        ...
        {
            Menu::EIngredient::IceCream,
            Menu::EIngredient::Chocolate,
            Menu::EIngredient::Cherry,
    ...
    static const Menu::MenuItem_t& MakeSundae()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::Sundae,
            GetSundaeIngredients(),
            GetSundaeIngredientCounts()
        };
        return item;
    }
    ...
    static const Menu::MenuItem_t& MakeChumFritters()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::ChumFritters,
            GetChumFrittersIngredients(),
    ...
    static const Menu::MenuItem_t& MakeKelpJerky()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::KelpJerky,
            GetKelpJerkyIngredients(),
    ...
    static const Menu::MenuItem_t& MakeChumOnAStick()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::ChumOnAStick,
            GetChumOnAStickIngredients(),
    ...
    static const Menu::MenuItem_t& MakeTarTarSauce()
    {
        static const Menu::MenuItem_t item
        {
            Menu::EMenuItem::TarTarSauce,
            GetTarTarSauceIngredients(),
